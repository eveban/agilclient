  ...
  render() {
    ...
    const panelHeader = (
      <span>
        ...
        <span className="header-helper">Last Update: 21m</span>
      </span>
    );
      ...
      <div className="p-grid dashboard">
        ...
        <div className="p-col-12 p-md-6 p-lg-4 task-list">
          <Panel header="Tasks">
            ...
            />
            <Menu ref={el => (this.menu = el)} popup model={items} />
              ...
              <li>
                <div>
                  ...
                  <Button
                    icon="pi-md-message"
                    title="Reply"
                    className="message-btn secondary-btn"
                  />
                </div>
              </li>
              <li>
                ...
                <TabPanel header="Sales Team">
                  <ul className="chat-messages">
                    <li className="message-from">
                      ...
                      />
                      <span>
                        Retro occupy organic, stumptown shabby chic pour-over
                        roof party DIY normcore.
                      </span>
                    </li>
                    <li className="message-own">
                      ...
                      />
                      <span>
                        Actually artisan organic occupy, Wes Anderson ugh
                        whatever pour-over gastropub selvage.
                      </span>
                    </li>
                    <li className="message-from">
                      <img
                    ...
                    <li className="message-own">
                      ...
                      />
                      <span>
                        Dreamcatcher locavore iPhone chillwave, occupy trust
                        fund slow-carb distillery art party narwhal.
                      </span>
                    </li>
                    <li className="message-own">
                ...
                <TabPanel header="Design Team">
                  <ul className="chat-messages">
                    ...
                    <li className="message-own">
                      ...
                      />
                      <span>
                        Tofu glossier bicycle rights banh mi direct trade austin
                        salvia slow-carb occupy.
                      </span>
                    </li>
                    <li className="message-from">
                      <img
                      ...
                      />
                      <span>
                        Crucifix tote bag pork belly distillery church-key
                        jianbing jean shorts taxidermy.
                      </span>
                    </li>
                    <li className="message-own">
                      <img
                      ...
                      />
                      <span>
                        Deep v hexagon street art migas butcher, keytar
                        biodiesel bicycle rights typewriter cornhole actually
                        next.
                      </span>
                    </li>
                    <li className="message-own">
                      <span>
                        Oh. You need a little dummy text for your mockup? How
                        quaint.
                      </span>
                    </li>
                    <li className="message-from">
                      ...
                      />
                      <span>
                        Salvia woke bushwick leggings mumblecore poke tumblr
                        master cleanse.
                      </span>
                    </li>
                    <li className="message-own">
                      ...
                      />
                      <span>
                        Skateboard ethical adaptogen, quinoa wolf poutine echo
                        park.
                      </span>
                    </li>
                  </ul>
              ...
              <ul>
                <li>
                  <div className="status-bar status-bar-1">
                    <div className="status-bar-value" style={{ width: '22%' }}>
                      22%
                    </div>
                  </div>
                  <span>Users</span>
                ...
                <li>
                  <div className="status-bar status-bar-2">
                    <div className="status-bar-value" style={{ width: '78%' }}>
                      78%
                    </div>
                  </div>
                  <span>Confirmed</span>
                ...
                <li>
                  <div className="status-bar status-bar-3">
                    <div className="status-bar-value" style={{ width: '51%' }}>
                      51%
                    </div>
                  </div>
                  <span>Defects</span>
                ...
                <li>
                  <div className="status-bar status-bar-4">
                    <div className="status-bar-value" style={{ width: '68%' }}>
                      68%
                    </div>
                  </div>
                  <span>Issues</span>
                ...
                <li>
                  <div className="status-bar status-bar-5">
                    <div className="status-bar-value" style={{ width: '80%' }}>
                      80%
                    </div>
                  </div>
                  <span>Searches</span>
        ...
        <div className="p-col-12 p-lg-6 p-grid-nopad">
              ...
              <table>
                ...
                <tbody>
                  <tr>
                    ...
                    <td>35%</td>
                    <td>
                      <i className="material-icons up-arrow">&#xE5D8;</i>
                    </td>
                    <td>
                      <Button
                        icon="pi-md-close"
                  ...
                  <tr>
                    ...
                    <td>28%</td>
                    <td>
                      <i className="material-icons down-arrow">&#xE5DB;</i>
                    </td>
                    <td>
                      <Button
                        icon="pi-md-close"
                  ...
                  <tr>
                    ...
                    <td>
                      <img
                        src="assets/layout/images/dashboard/flag-uk.png"
                        alt="serenity-layout"
                        width="45"
                      />
                    </td>
          ...
          <div className="p-col-12 image-box">
            <div className="card">
              <img
                src="assets/layout/images/dashboard/gradient-waters.png"
                alt="serenity-layout"
              />
              ...
              <div className="image-box-content">
                ...
                <p>
                  Derive inexpedient reason law virtues superiority victorious.
                  Overcome pious horror suicide revaluation. Holiest ocean
                  society disgust passion value love. Faithful mountains
                  morality hope disgust merciful moral will revaluation society
                  fearful love.
                </p>
                <p>
                ...
                <p>
                  In et blandit turpis, ut congue nibh. Nam vitae tincidunt
                  nunc, sed accumsan lacus. Sed efficitur malesuada augue ut
                  varius. Pellentesque ultricies leo massa, eu posuere diam
                  sodales quis.
                </p>
                <div className="image-box-footer">
                  <Button
                    ...
                    title="Close"
                    label="Close"
                    className="remove-btn orange-btn"
            ...
            <div className="user-card card">
              ...
              <div className="user-card-content">
                <img
                  ...
                  alt="serenity-layout"
                />
                <Button icon="pi-md-settings" className="secondary-btn" />
