...
export class AppTopbar extends Component {
  ...
  render() {
    const topbarClass = classNames('topbar-menu fadeInDown', {
      'topbar-menu-active': this.props.topbarMenuActive,
    });
    const horizontalIcon = this.props.layoutMode === 'horizontal' && (
      <button className="p-link topbar-logo">
        <img alt="logo" src="assets/layout/images/logo-slim.png" />
        <span className="app-name">z</span>
      </button>
    );
          ...
          <ul className={topbarClass}>
            {/* <li
              className={classNames({
                'active-topmenuitem':
                  this.props.activeTopbarItem === 'settings',
              })}
            >
              <button
                className="p-link"
            ...
            {/* <li
              className={classNames({
                'active-topmenuitem':
                  this.props.activeTopbarItem === 'messages',
              })}
            >
              <button
                className="p-link"
